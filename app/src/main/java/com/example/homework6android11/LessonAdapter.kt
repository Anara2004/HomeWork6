...
import com.example.homework6android11.databinding.ItemRecyclerBinding

class LessonAdapter(private val data : ArrayList<LessonModel>): RecyclerView.Adapter<LessonAdapter.LessonViewHolder>() {
